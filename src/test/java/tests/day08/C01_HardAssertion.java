...
public class C01_HardAssertion {
    ...
    public void test1(){
        ...
        //hard assert oldugu icin ilk failed olan asssertion da execution stops
        //ancak bu hata giderilirse test calismaya devem eder
        System.out.println("assertion failed oldugunda bu satir calismaz");
        // java kelimesi aratin ve listedeki ilk urunun java kelimesi icerdigini test edin
        WebElement aramaKutusu=driver.findElement(By.id("twotabsearchtextbox"));
        aramaKutusu.sendKeys("java"+ Keys.ENTER);
        WebElement ilkUrun=driver.findElement(By.xpath("(//span[@class='a-size-base a-color-base a-text-normal'])[1]"));
