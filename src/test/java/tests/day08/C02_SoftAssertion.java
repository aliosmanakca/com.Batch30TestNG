...
public class C02_SoftAssertion {
    ...
    public void test(){
        ...
        // title'in amazon icerdigini test edin
        softAssert.assertTrue(driver.getTitle().contains("zamazon"),"title zamazon icermiyor");
        ...
        System.out.println("assertionlardan biri bile failed olursa assertAll dan sonrasi calismaz");
    }
    @AfterClass
